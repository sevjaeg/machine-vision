...
\subsubsection{Weighted match counting}
...
\begin{figure}
	\centering
	\includegraphics[width=11cm]{rgb3.PNG}
	\caption{Recognition results for point cloud 3 with RGB SIFT}
	\label{rgb3}
\end{figure}
