...
of iterations and thus the runtime. Therefore, this parameter involves a trade-off between accuracy and complexity.
...
floor in yellow, left open door in blue, closed door in green) are detected nicely, however there are some interesting artefacts.
...
which is likely to be an artefact caused by the viewpoint and the FOV. However, this plane again contains only a few data points.
...
unpleasant artefacts such as the highly regular holes in the lower part of Figure \ref{door_basic}. However, there 
...
favour of the (similarly easy to calculate) MSAC. In case the estimation accuracy is of utmost importance, MLESAC can be considered.
