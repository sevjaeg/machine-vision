...
It is nonetheless possible that DBSCAN yields two clusters for one detected object. This is mitigated by searching for clusters with small distances in the voting space and unifying these clusters by averaging them.
