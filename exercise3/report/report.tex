...
A major drawback of this method is that it scales only partially to different images. The parameter $t_{SIFT}$ has to be tuned for different types of images to avoid that the aforementioned problems arise, especially if the structure of the image differs notably.
